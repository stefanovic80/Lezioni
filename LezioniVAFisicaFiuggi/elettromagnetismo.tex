...
\begin{figure}[th]
\includegraphics[width=6cm]{forzaElettrica.jpg}%GaussLastraPiana.png
\centering
\end{figure}
...
\begin{figure}[th]
\includegraphics[width=8cm]{lineeCampoElettrico.jpg}%CondensatoreFaccePianeParallele.png
\centering
\end{figure}
...
\begin{figure}[th]
\includegraphics[width=6cm]{CondensatoreFaccePianeParallele.png}%Condensatore.png
\includegraphics[width=6cm]{Condensatore.png}%Condensatore.png
\centering
\end{figure}
